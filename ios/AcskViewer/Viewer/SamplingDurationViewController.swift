...
//        }
//
//        if let service = target as? ExtendedTemperatureSensorService {
//            picker.isHidden = true
//            if let duration = service.settingData?.samplingDuration {
//                durationField.text = "\(Int(duration.duration * 1000))"
//            }
...
//            if let value = Int(durationField.text!) {
//                let sd = SamplingDurationType(milliSeconds: UInt16(value))
//                let setting = SensorSettingData<ExtendedTemperatureRange>(status: (service.settingData?.status)!, samplingDuration: sd, range: (service.settingData?.range)!)
//                service.writeSetting(setting)
//                service.readSetting()
//            }
//        }
