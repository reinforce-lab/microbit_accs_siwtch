...
class LogReaderViewController: UITableViewController, MicrobitDeviceDelegate, SensorDataModelDelegate {
    ...
    override func tableView(_ tableView: UITableView, willDisplay cell: UITableViewCell, forRowAt indexPath: IndexPath)
    {
        ...
        dataModels![(indexPath as NSIndexPath).row].addCell(dataCell!)
    }
